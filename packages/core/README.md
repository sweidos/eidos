...
```ts
import { resource, action } from '@adityaraj/eidos'
...
```tsx
import { EidosProvider } from '@adityaraj/eidos'
...
```ts
import { replayQueue } from '@adityaraj/eidos'
...
```ts
import { useEidosStatus, useEidosResource, useEidosQueue } from '@adityaraj/eidos'
