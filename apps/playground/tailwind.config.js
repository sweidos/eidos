...
// Style: Brutalist/Terminal · Stack: Developer Tool/IDE
// Colors: Slate deep bg + Terminal Green (#22C55E) CTA · Typography: Space Mono
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        // Space Mono everywhere — brutalist, raw, terminal aesthetic
        // Recommended by ui-ux-pro-max for developer tools
